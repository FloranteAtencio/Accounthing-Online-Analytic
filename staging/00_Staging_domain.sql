...
DROP DOMAIN IF EXISTS bigint_account_code_type CASCADE;
CREATE DOMAIN bigint_account_code_type AS BIGINT
    CONSTRAINT bigint_valid_account_code CHECK (VALUE > 0);
